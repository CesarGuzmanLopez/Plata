 ...
 */
     ...
     */
        ...
        {            //Method inherited from \Illuminate\View\Compilers\BladeCompiler
                        return \HTMLMin\HTMLMin\Compilers\MinifyCompiler::newComponentHash($component);
        }
                    /**
        ...
        {            //Method inherited from \Illuminate\View\Compilers\BladeCompiler
                        return \HTMLMin\HTMLMin\Compilers\MinifyCompiler::compileClassComponentOpening($component, $alias, $data, $hash);
        }
                    /**
        ...
        {            //Method inherited from \Illuminate\View\Compilers\BladeCompiler
                        return \HTMLMin\HTMLMin\Compilers\MinifyCompiler::sanitizeComponentAttribute($value);
        }
                    /**
     ...
     */
         ...
         *
         *      */
        public  function validateWithBag($errorBag, $rules, ...$params)
        {
...
namespace Laravel\Passport {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|Client[]|Client create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|Client[]|Client make($attributes = [])
    */
    class ClientFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
